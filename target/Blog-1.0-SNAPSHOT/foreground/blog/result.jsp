					...
					<c:otherwise>
						<c:forEach var="blog" items="${blogList }">
					  	  <li style="margin-bottom: 20px">
						  	<span class="title"><a href="${pageContext.request.contextPath}/blog/articles/${blog.id}.ac" target="_blank">${blog.title }</a></span>
						  	<span class="summary">摘要: ${blog.content }...</span>
						  	<span class="link"><a href="${pageContext.request.contextPath}/blog/articles/${blog.id}.ac">http://blog.java1234.com/blog/articles/${blog.id}.ac</a>&nbsp;&nbsp;&nbsp;&nbsp;发布日期：${blog.releasedatestr }</span>
						  </li>
						</c:forEach>
					</c:otherwise>
				</c:choose>
